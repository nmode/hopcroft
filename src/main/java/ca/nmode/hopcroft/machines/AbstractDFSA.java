 ...
 * @author Naeem Model
 */
public abstract class AbstractDFSA<S extends State, I, K, V, C> extends AbstractFSA<S, I, K, V>
     ...
     * 
     * @param states        the set of states of the new deterministic finite-state acceptor
     * @param inputElements the set of input elements of the new deterministic finite-state acceptor
     * @param transitions   the transition map of the new deterministic finite-state acceptor
     * @param startState    the start state of the new deterministic finite-state acceptor
     * @param acceptStates  the set of accept states of the new deterministic finite-state acceptor
     * 
