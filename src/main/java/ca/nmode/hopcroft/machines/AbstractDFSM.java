 ...
 * @author Naeem Model
 */
public abstract class AbstractDFSM<S extends State, I, K, V, C> extends AbstractFSM<S, I, K, V>
     ...
     * start state.
     * 
     * @param states        the set of states of the new deterministic finite-state machine
     * @param inputElements the set of input elements of the new deterministic finite-state machine
     * @param transitions   the transition map of the new deterministic finite-state machine
     * @param startState    the start state of the new deterministic finite-state machine
     * 
